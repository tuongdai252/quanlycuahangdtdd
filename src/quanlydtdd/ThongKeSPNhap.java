 ...
 * @author ASUS
 */
public class ThongKeSPNhap extends javax.swing.JInternalFrame {

    /**
     * Creates new form QuanLyThongTinSanPham
     */
    String [] columns = new String [] {"Mã sản phẩm","Tên sản phẩm","Số lượng","Ngày nhập"};
    ...
    void HienThiDS(ArrayList dshd) 
    {
        ...
        for (int i = 0; i < dshd.size(); i++) {
            ...
            ArrayList ds = hoadonnhapBUS.TimKiemTheoTuKhoa(a.mahdn);
            hoadonnhapDTO b = (hoadonnhapDTO) ds.get(0);
            ArrayList dssp = sanphamBUS.TimKiemTheoTuKhoa(a.masp);
            sanphamDTO c = (sanphamDTO) dssp.get(0);
            modeltable.insertRow(i, new Object[]{a.masp, c.tensp, a.soluong, b.ngaynhap});
        }
        jTable1.setModel(modeltable);
    }
    
    public ThongKeSPNhap()
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(NgayRadioButton, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void ThongKeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThongKeButtonActionPerformed
        ...
        if(NgayRadioButton.isSelected())
        {
            ...
            ArrayList dshd = chitiethoadonnhapBUS.TimKiemTheoNgay(thoigian);
            HienThiDS(dshd);
        }
        else if(ThangRadioButton.isSelected())
        {
            thoigian = ThangText.getText() + "/" + NamText.getText();
            ArrayList dshd = chitiethoadonnhapBUS.TimKiemTheoThang(thoigian);
            HienThiDS(dshd);
        }

 ...
 * @author ASUS
 */
public class ThemHoaDonNhap extends javax.swing.JFrame {
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(NgayNhapText, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(67, 67, 67))
        );
    ...
    private void LuuButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LuuButtonActionPerformed
        ...
        if (hoadonnhapBUS.kiemTraTonTai(MaHDText.getText()) == true)
        {
        ...
        if (nhacungcapBUS.kiemTraTonTai(MaNCCText.getText()) == false)
        {
        ...
        hd.mahdn = MaHDText.getText();
        hd.manv = MaNVText.getText();
        hd.mancc = MaNCCText.getText();
        hd.ngaynhap = NgayNhapText.getText();
        hd.tongtien = Float.valueOf(TongTienText.getText());
        hoadonnhapBUS.Them(hd);
        for (int i = 0; i < modeltable.getRowCount(); i++) {
            //Them chi tiet hoa don
            chitiethoadonnhapDTO ct = new chitiethoadonnhapDTO();
            ct.mahdn = hd.mahdn;
            ...
            int rtt = (int) tt;
            String thanhtien = cnw.NumToWords(rtt);
            ct.thanhtien = thanhtien + " đồng";
            chitiethoadonnhapBUS.Them(ct);

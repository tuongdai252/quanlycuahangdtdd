...
public class ThongKeThu extends javax.swing.JInternalFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(NgayXuatLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
    ...
    private void ThongKeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThongKeButtonActionPerformed
        ...
        if(NgayRadioButton.isSelected())
        {
            ...
            ArrayList dshd = hoadonxuatBUS.TimKiemTheoNgay(thoigian);
            HienThiDS(dshd);
        }
        else if(ThangRadioButton.isSelected())
        {
            thoigian = ThangText.getText() + "/" + NamText.getText();
            ArrayList dshd = hoadonxuatBUS.TimKiemTheoThang(thoigian);
            HienThiDS(dshd);
        }
